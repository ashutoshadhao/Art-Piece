            ...
            <div className="container text-center text-md-start mt-5">
              ...
              <div className="row mt-3">
                ...
                <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  {/* Content */}
                  <h6 className="text-uppercase fw-bold">Art - Piece</h6>
                  <hr
                  ...
                  />
                  <p>
                  Discover unique, handcrafted treasures from talented artisans around the world. Every item is crafted with care and attention to detail, creating one-of-a-kind pieces that you won't find anywhere else. Shop with us to support independent artists and makers, and to add a touch of individuality to your own personal style. 
                  </p>
                </div>
