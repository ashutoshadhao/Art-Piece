...
const LoginSignUp = () => {
  ...
  const { error, loading, isAuthenticated, isVerified } = useSelector(
    (state) => state.user
  );
  ...
  useEffect(() => {
    ...
    if (isAuthenticated) {
      const redirect = isVerified === false ? "/verify/user" : location.search ? location.search.split("=")[1] : "/account";
      history(redirect);
    }
          ...
          >
            <div className="LoginSignUpBox  ">
              ...
              <form className="loginForm" ref={loginTab} onSubmit={loginSubmit}>
                ...
                <Link to="/password/forgot" className="m-2">
                  Forget Password ?
                </Link>
                <input type="submit" value="Login" className="loginBtn m-2" />
              </form>
              <form
